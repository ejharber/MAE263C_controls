...
class img_processing_node(object):
    ...
    def __init__(self):
        ...
        self.pub_image_force2 = rospy.Publisher("/digit_data/force2", Vector3)
    ...
    try:
        ...
        while not rospy.is_shutdown():
            if img_processing_node.last_img is not None: #ensure we have data to process
                ...
                # JIMMYS CODE
                thresh, contours, visual, normalized_areas, mean_x, mean_y = process_image(img_processing_node.last_img)
                ...
                img_processing_node.pub_image_force2.publish(msg_force2)
